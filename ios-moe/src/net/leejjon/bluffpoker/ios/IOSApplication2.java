...
public class IOSApplication2 implements Application {
    public static abstract class Delegate extends NSObject implements UIApplicationDelegate {
        ...
        @Selector("alloc")
        public static native IOSApplication2.Delegate alloc();

        protected abstract IOSApplication2 createApplication ();
    ...
    public IOSApplication2 (BluffPokerGame listener, IOSApplicationConfiguration config) {
    ...
    final boolean didFinishLaunching (UIApplication uiApp, NSDictionary<?, ?> launchOptions) {
        ...
        // setup libgdx
        this.input = new IOSInput2(this);
        this.graphics = IOSGraphics2.alloc().init(scale, this, config, input, config.useGL30);
        Gdx.gl = Gdx.gl20 = graphics.gl20;
        Gdx.gl30 = graphics.gl30;
        this.files = new IOSFiles();
        this.audio = new IOSAudio(config);
        this.net = new IOSNet2(this);
