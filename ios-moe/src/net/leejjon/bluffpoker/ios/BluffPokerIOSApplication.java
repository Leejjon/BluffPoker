...
public class BluffPokerIOSApplication implements Application {
    public static abstract class Delegate extends NSObject implements UIApplicationDelegate {
        ...
        @Selector("alloc")
        public static native BluffPokerIOSApplication.Delegate alloc();

        protected abstract BluffPokerIOSApplication createApplication ();
    ...
    public BluffPokerIOSApplication(BluffPokerGame listener, IOSApplicationConfiguration config) {
    ...
    final boolean didFinishLaunching (UIApplication uiApp, NSDictionary<?, ?> launchOptions) {
        ...
        // setup libgdx
        this.input = new BluffPokerIOSInput(this);
        this.graphics = BluffPokerIOSGraphics.alloc().init(scale, this, config, input, config.useGL30);
...
//        this.contactStore = CNContactStore.alloc().init();
        ...
        this.input.setupPeripherals(listener);
